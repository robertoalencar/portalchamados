 ...
 * 
 */
@FacesConverter(value="statusCopergasConverter", forClass = StatusCopergas.class)
public class StatusCopergasConverter implements Converter {
	...
	if (value == null || value.equals("")) {
		...
		return fachada.consultarStatusCopergasPorDescricao(value);
