 ...
 * 
 */
@FacesConverter(value="origemChamadoConverter", forClass = OrigemChamado.class)
public class OrigemChamadoConverter implements Converter {
	...
	if (value == null || value.equals("")) {
		...
		return fachada.consultarOrigemChamadoPorDescricao(value);
