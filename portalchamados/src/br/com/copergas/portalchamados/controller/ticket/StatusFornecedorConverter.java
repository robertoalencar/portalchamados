 ...
 * 
 */
@FacesConverter(value="statusFornecedorConverter", forClass = StatusFornecedor.class)
public class StatusFornecedorConverter implements Converter {
	...
	if (value == null || value.equals("")) {
		...
		return fachada.consultarStatusFornecedorPorDescricao(value);
