 ...
 * 
 */
@FacesConverter(value="ticketSubCategoriaConverter", forClass = TicketSubCategoria.class)
public class TicketSubCategoriaConverter implements Converter {
	...
	if (value == null || value.equals("")) {
		...
		return fachada.consultarTicketSubCategoriaPorDescricao(value);
